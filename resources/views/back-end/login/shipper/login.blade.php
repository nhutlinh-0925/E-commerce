...
<body class="">
  ...
  <main class="main-content  mt-0">
    <div class="page-header min-vh-100" style="background-image: url('https://kenhz.net/wp-content/uploads/2019/11/giao-hang-ung-truoc.jpg'); background-position: top;">
        ...
        <div class=" justify-content-center">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form action="{{ route('shipper.doLogin') }}" method="POST" >
