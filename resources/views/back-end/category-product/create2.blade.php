    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="">Thêm danh mục sản phẩm</a></li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <div class="card-body">
      ...
      <form class="row g-3" method="POST">
        <div class="col-12">
          ...
          <input type="text" class="form-control" id="inputNanme4" name="dmsp_TenDanhMuc" placeholder="Nhập tên" value="{{ old('dmsp_TenDanhMuc', $request->dmsp_TenDanhMuc ?? '') }}">
        ...
        <div class="col-12">
          ...
          <textarea class="form-control" placeholder="Nhập mô tả" id="floatingTextarea" name="dmsp_MoTa" style="height: 100px;">{{ old('dmsp_MoTa', $request->dmsp_MoTa ?? '') }}</textarea>
          @error ('dmsp_MoTa')
                <span style="color: red;">{{ $message }}</span>
            @enderror
        </div>
