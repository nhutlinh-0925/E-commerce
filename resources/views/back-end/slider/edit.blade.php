    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="">Cập nhật slider</a></li>
            </ol>
        </nav>
    </div>
@endsection
        ...
        <div class="card-body">
            ...
            <form class="row g-3" method="POST" enctype="multipart/form-data">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="inputNanme4" name="sl_TieuDe" placeholder="Nhập tiêu đề" value="{{ old('sl_TieuDe', $slider->sl_TieuDe ?? '') }}">
                    @error ('sl_TieuDe')
                ...
                <div class="col-12">
                    ...
                    <select class="form-select" name="sl_TrangThai" id="validationDefault04" >
                        ...
                        <option value="1" {{ $slider->sl_TrangThai == '1' ? 'selected' : '' }}>
                            Hiển thị
                        </option>
                        <option value="0" {{ $slider->sl_TrangThai == '0' ? 'selected' : '' }}>
                            Ẩn
                        </option>
                    </select>
                    @error ('sl_TrangThai')
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <br>
                        <img id="output" src="{{ url('/storage/images/sliders/'.$slider->sl_HinhAnh) }}" width="350px" height="170px">
                    </div>
                </div>
