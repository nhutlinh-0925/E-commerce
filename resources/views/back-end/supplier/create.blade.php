    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="">Thêm nhà cung cấp</a></li>
            </ol>
        </nav>
    </div>
@endsection
            ...
            <form class="row g-3" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="" name="ncc_Email" placeholder="Nhập email" value="{{ old('ncc_Email', $request->ncc_Email ?? '') }}">
                        @error ('ncc_Email')
                        <span style="color: red;">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="" name="ncc_SoDienThoai" placeholder="Nhập số điện thoại" value="{{ old('ncc_SoDienThoai', $request->ncc_SoDienThoai ?? '') }}">
