            ...
            <form class="row g-3" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="mgg_NgayBatDau" name="mgg_NgayBatDau" placeholder="Chọn ngày bắt đầu" value="{{ old('mgg_NgayBatDau', $request->mgg_NgayBatDau ?? '') }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="mgg_NgayKetThuc" name="mgg_NgayKetThuc" placeholder="Chọn ngày hết hạn" value="{{ old('mgg_NgayKetThuc', $request->mgg_NgayKetThuc ?? '') }}">
                ...
                <div class="col-12">
                    ...
                    <input type="number" class="form-control" id="mgg_GiaTri" name="mgg_GiaTri" placeholder="Nhập giá trị giảm" value="{{ old('mgg_GiaTri', $request->mgg_GiaTri ?? '') }}">
                    @error ('mgg_GiaTri')
                    <span style="color: red;">{{ $message }}</span>
                    @enderror
                </div>
