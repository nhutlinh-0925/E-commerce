<!-- BEGIN: SideNav-->
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-dark sidenav-active-rounded">
      <div class="brand-sidebar">
        <h1 class="logo-wrapper"><a class="brand-logo darken-1" href="index.html"><img class="hide-on-med-and-down " src="/template/back-end/images/logo/materialize-logo.png" alt="materialize logo"><img class="show-on-medium-and-down hide-on-med-and-up" src="/template/back-end/images/logo/materialize-logo-color.png" alt="materialize logo"><span class="logo-text hide-on-med-and-down">Materialize</span></a><a class="navbar-toggler" href="#"><i class="material-icons">radio_button_checked</i></a></h1>
      </div>
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="accordion">
        ...
        <li class="bold"><a class="collapsible-header waves-effect waves-cyan "><i class="material-icons">dvr</i><span class="menu-title" data-i18n="Templates">Danh mục sản phẩm</span></a>
          <div class="collapsible-body">
            <ul class="collapsible collapsible-sub" data-collapsible="accordion">
              <li><a class="collapsible-header waves-effect waves-cyan" href="/admin/category-products/add"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Vertical">Thêm danh mục sản phẩm</span></a>
                {{--  <div class="collapsible-body">
              ...
              <li><a class="collapsible-header waves-effect waves-cyan" href="/admin/category-products"><i class="material-icons">radio_button_unchecked</i><span data-i18n="Horizontal">Danh sách danh mục</span></a>
                {{--  <div class="collapsible-body">
                  <ul class="collapsible" data-collapsible="accordion">
