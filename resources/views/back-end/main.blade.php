...
@include('back-end.pages.head')
@include('back-end.pages.header')

  <body class="vertical-layout page-header-light vertical-menu-collapsible vertical-dark-menu preload-transitions 2-columns   " data-open="click" data-menu="vertical-dark-menu" data-col="2-columns">


    @include('back-end.pages.chuabiet')
    @include('back-end.pages.sidenav')

    {{--  @include('back-end.pages.main')  --}}
    <!-- BEGIN: Page Main-->
                ...
                <div class="row">
                    <div class="col s12 m4">
                        ...
                        <div class="card-content  center">
                            ...
                            <img src="/template/back-end/images/cards/watch.png" alt="" class="responsive-img">
                    ...
                    <div class="col s12 m4">
                        ...
                        <div class="card-content center">
                            ...
                            <img src="/template/back-end/images/cards/headphones-2.png" alt="" class="responsive-img">
                        </div>
                    ...
                    <div class="col s12 m4">
                        ...
                        <div class="card-content center">
                            ...
                            <img src="/template/back-end/images/cards/iphonec.png" alt="" class="responsive-img">
                ...
                <div id="ecommerce-offer">
                    <div class="row">
                        ...
                        <div class="card gradient-shadow gradient-45deg-light-blue-cyan border-radius-3 animate fadeUp">
                            <div class="card-content center">
                                <img src="/template/back-end/images/icon/apple-watch.png" class="width-40 border-round z-depth-5 responsive-img" alt="image">
                        ...
                        <div class="card gradient-shadow gradient-45deg-red-pink border-radius-3 animate fadeUp">
                            <div class="card-content center">
                                <img src="/template/back-end/images/icon/printer.png" class="width-40 border-round z-depth-5 responsive-img" alt="images">
                        ...
                        <div class="card gradient-shadow gradient-45deg-amber-amber border-radius-3 animate fadeUp">
                            <div class="card-content center">
                                <img src="/template/back-end/images/icon/laptop.png" class="width-40 border-round z-depth-5 responsive-img" alt="image">
                        ...
                        <div class="card gradient-shadow gradient-45deg-green-teal border-radius-3 animate fadeUp">
                            <div class="card-content center">
                                <img src="/template/back-end/images/icon/bowling.png" class="width-40 border-round z-depth-5 responsive-img" alt="image">
      ...
      <div class="collection border-none mb-0">
        ...
        <ul class="collection right-sidebar-chat p-0 mb-0">
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-online avatar-50"><img src="/template/back-end/images/avatar/avatar-7.png" alt="avatar">
              <i></i>
            </span>
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-online avatar-50"><img src="/template/back-end/images/avatar/avatar-1.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-off avatar-50"><img src="/template/back-end/images/avatar/avatar-2.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-online avatar-50"><img src="/template/back-end/images/avatar/avatar-3.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
              <h6 class="line-height-0">Caleb Richards</h6>
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-online avatar-50"><img src="/template/back-end/images/avatar/avatar-4.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-off avatar-50"><img src="/template/back-end/images/avatar/avatar-5.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-online avatar-50"><img src="/template/back-end/images/avatar/avatar-6.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-off avatar-50"><img src="/template/back-end/images/avatar/avatar-7.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-off avatar-50"><img src="/template/back-end/images/avatar/avatar-8.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-online avatar-50"><img src="/template/back-end/images/avatar/avatar-9.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-off avatar-50"><img src="/template/back-end/images/avatar/avatar-10.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-off avatar-50"><img src="/template/back-end/images/avatar/avatar-11.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
          ...
          <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
            <span class="avatar-status avatar-online avatar-50"><img src="/template/back-end/images/avatar/avatar-12.png" alt="avatar">
              <i></i>
            </span>
            <div class="user-content">
      ...
      <div class="activity">
        ...
        <ul class="widget-timeline mb-0">
          ...
          <li class="timeline-items timeline-icon-red active">
            ...
            <div class="timeline-content">
              <img src="/template/back-end/images/icon/pdf.png" alt="document" height="30" width="25" class="mr-1">Registration.doc
            </div>
          </li>
          <li class="timeline-items timeline-icon-indigo active">
            ...
            <p class="timeline-text">Here are some news feed interactions concepts.</p>
            <div class="timeline-content">
              <img src="/template/back-end/images/icon/pdf.png" alt="document" height="30" width="25" class="mr-1">Activity.doc
            </div>
          </li>
        ...
        <ul class="widget-timeline mb-0">
          ...
          <li class="timeline-items timeline-icon-red">
            ...
            <p class="timeline-text">Here are some news feed interactions concepts.</p>
            <div class="timeline-content">
              <img src="/template/back-end/images/icon/pdf.png" alt="document" height="30" width="25" class="mr-1">Database-log.doc
            </div>
          </li>
        </ul>
...
<!-- END: Page Main-->
    ...
    {{--  @include('back-end.pages.setting')  --}}

    @include('back-end.pages.footer')
