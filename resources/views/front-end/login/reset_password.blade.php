    ...
    <div class="col s12">
        <div class="container"><div id="login-page" class="row">
                <div class="col s12 m6 l4 z-depth-4 card-panel border-radius-6 login-card bg-opacity-8">
                    <form class="login-form" action="{{ route('user.do_Reset_password') }}" method="POST">
                        <div class="row">
                            <div class="input-field col s12 ">
                                <h5 class="ml-4"><b>Đổi mật khẩu</b></h5>
                        ...
                        <div class="row">
                            <div class="input-field col s12 m12 l12">
                                <button type="submit" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12">Đổi mật khẩu</button>
                            </div>
